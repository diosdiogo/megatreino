...
if ($state == "C") {
	$lista = '{"result":[' . json_encode(getModalidadePlano($conexao, $id, $mod)) . ']}';
	echo $lista;
}

function getModalidadePlano($conexao, $id, $mod) {
	$retorno = array();
/*
